...
class FeatureFusionNetwork(nn.Module):
    ...
    def forward(self, src_temp, mask_temp, src_search, mask_search, pos_temp, pos_search, exc):
        ...
        memory_temp, memory_search, mergeq = self.encoder(src1=src_temp, src2=src_search, exc=exc,
        ...
        return hs.unsqueeze(0).transpose(1, 2), mergeq.unsqueeze(0).transpose(1, 2)
...
class Encoder(nn.Module):
    ...
    def forward(self, src1, src2, exc,
        ...
        for layer in self.layers:
            output1, output2, qs = layer(output1, output2, exc, src1_mask=src1_mask,
                                     src2_mask=src2_mask,
